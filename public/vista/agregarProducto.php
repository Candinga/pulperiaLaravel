...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Agregar Prodúcto</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <div class="container" >
    <div class="row">
      <div class="col-md-12">
        <form method="POST" action="../controlador/AgregarProducto.php" enctype="multipart/form-data">
          <div class="container" >
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control"  placeholder="Ingrese el precio mayorista" id="txtPrecioMayorista" name="txtPrecioMayorista" autocomplete="off">
                  </div>
                </div>
                 <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control"  placeholder="Ingrese la costo mayorista" id="txtCostoMayorista" name="txtCostoMayorista" autocomplete="off">
                  </div>
                </div>
                <div class="col-md-12">
                <br><br><strong><center><button class="btn btn-primary" id="btnGuardar" /> ALMACENAR PRODUCTO</button></strong></center>
                <br>
              </div> 
              </div>
            </div>  
